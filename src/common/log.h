...
#define LOG_T(logger, msg)     LOG4CXX_TRACE(logger, msg)
#define LOG_DEBUG(logger, msg) LOG4CXX_DEBUG(logger, msg)
#define LOG_D(logger, msg)     LOG4CXX_DEBUG(logger, msg)
#define LOG_ERROR(logger, msg) LOG4CXX_ERROR(logger, msg)
#define LOG_E(logger, msg)     LOG4CXX_ERROR(logger, msg)
#define LOG_FATAL(logger, msg) LOG4CXX_FATAL(logger, msg)
#define LOG_F(logger, msg)     LOG4CXX_FATAL(logger, msg)
#define LOG_INFO(logger, msg)  LOG4CXX_INFO(logger, msg)
#define LOG_I(logger, msg)     LOG4CXX_INFO(logger, msg)
#define LOG_WARN(logger, msg)  LOG4CXX_WARN(logger, msg)
#define LOG_W(logger, msg)     LOG4CXX_WARN(logger, msg)
