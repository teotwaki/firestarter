/**
 * @file mirror/concept_check/meta_typedef.hpp
...
#ifndef MIRROR_CONCEPT_CHECK_META_TYPEDEF_1011291729_HPP
#define MIRROR_CONCEPT_CHECK_META_TYPEDEF_1011291729_HPP
...
// MetaType
MIRROR_CONCEPT_TESTER_BEGIN(meta_typedef_tag)
(X*,
