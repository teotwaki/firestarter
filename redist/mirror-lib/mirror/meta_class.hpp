...
#else
#define MIRROR_REG_CLASS_BEGIN_CTS(ELABORATED_TYPE, NAMESPACE, CLASS, SPELLED) \
MIRROR_REG_TYPE_BASICS(class, NAMESPACE, CLASS, SPELLED) \
MIRROR_ADD_TO_GLOBAL_LIST( \
...
#define MIRROR_REG_CLASS_BEGIN(ELABORATED_TYPE, NAMESPACE, CLASS) \
	MIRROR_REG_CLASS_BEGIN_CTS(ELABORATED_TYPE, NAMESPACE, CLASS, ())
#endif
